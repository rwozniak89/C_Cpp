...
int funkcjaGlownaPierwiastek()
{
    ...
    scanf("%d", &stopien);
    wynik == pow(liczba, (1/stopien)); // to nie dziala i nie wiem co zmienic 
	printf("Pierwiastek stopnia %d z liczby %d to %d\n",stopien, liczba, wynik);
    system("PAUSE");
...
int temperatura()
{
	...
	scanf("%d", &stopnie);
	wynik = stopnie*33,8;
	//wynik = cels_to_fahr(stopnie); - w ksiazce jest ta funkcja ale nie dziala tu, chyba, ze zle uzylam 
...
int main(int argc, char** argv) {
	...
	switch(opcja)
	{
		...
		case 2:
			...
			break;
		case 3:
			printf("Wybrales/as opcje pierwiastek.\n");
